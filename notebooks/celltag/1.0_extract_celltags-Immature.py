...
plot_dir = out_dir + "plots/Immature/"
...
# %%
# !zless {fastq_dir}{sample}_S1_L001_R2_001.fastq.gz | head

# %%
# !zless {fastq_dir}{sample}_S1_L001_R2_001.fastq.gz | wc -l

# %%
# !zless {fastq_dir}{sample}_S1_L001_R2_001.fastq.gz | sed "/[^ACTG]/d" | head

# %%
# !zless {fastq_dir}{sample}_S1_L001_R2_001.fastq.gz | sed "/[^ACTG]/d" | wc -l

# %%
# !zless {fastq_dir}{sample}_S1_L001_R2_001.fastq.gz | sed "/[^ACTG]/d" | ag "TGTACG[ACTG]{8}GAATTC" | wc -l

# %%

# %%
cmd = f'zless {fastq_dir}{sample}_S1_L001_R2_001.fastq.gz | sed "/[^ACTG]/d" | head'
cmd.split()

# %%
# read_2 = !zless {fastq_dir}{sample}_S1_L001_R{2}_001.fastq.gz | sed "/[^ACTG]/d"
...
# %%
# read_1 = !zless {fastq_dir}{sample}_S1_L001_R{1}_001.fastq.gz | sed "/[^ACTG]/d"
...
# %%
# read_1_full = !zless {fastq_dir}{sample}_S1_L001_R{1}_001.fastq.gz
# read_2_full = !zless {fastq_dir}{sample}_S1_L001_R{2}_001.fastq.gz
...
# %%
tmp = re.search(prefix + "([ACTG]{8})" + suffix, df.read_2[4])
assert tmp is not None
tmp
...
# %%
tmp = re.findall(prefix + "([ACTG]{8})" + suffix, df.read_2[4])
assert tmp is not None
tmp
...
# %%
barcodes = [bc[:-2] for bc in barcodes if bc.endswith("2")]
...
alt.Chart(source).mark_bar().encode(y="count():Q", x=alt.X("values:Q", bin=alt.Bin(maxbins=60)))
