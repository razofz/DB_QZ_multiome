...
# %% [markdown]
# ## Clone SAILERX repo if we haven't done that already

# %%
# # !rm -rf ${PROJECT_PATH}/notebooks/Diverse/SAILERX

# %%
# !git clone https://github.com/uci-cbcl/SAILERX $PROJECT_PATH/notebooks/Diverse/SAILERX
...
# %%
# !git checkout -b commit-to-use 1b904bf3b984e5f4db088288db1ae1498f9a4b32

# %% [markdown]
# [The commits](https://github.com/uci-cbcl/SAILERX/commits/main), with above commit the latest at the time of writing (2023-04-26).
...
outputs = {
    "h5_file": f"{os.getenv('PROJECT_PATH')}/notebooks/Diverse/SAILERX/data/diverse.h5"
}
...
# %%
diverse_metadata = pd.read_table(inputs["metadata"], index_col="barcode")
...
# %%
# !ls $PROJECT_PATH/notebooks/Diverse/SAILERX
...
f"Notebook run time was {round(time_diff.seconds / 60)} minutes, {time_diff.seconds % 60} seconds."
