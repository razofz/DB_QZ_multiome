...
```{r}
newer_sailerx_colours <- new_sailerx_colours
newer_sailerx_colours
newer_sailerx_colours[["0"]] <- new_sailerx_colours[["6"]]
newer_sailerx_colours[["6"]] <- new_sailerx_colours[["0"]]
newer_sailerx_colours
```

```{r}
# write.table(new_sailerx_colours, file = outputs[["sailerx_colours"]], col.names = F)
write.table(newer_sailerx_colours, file = outputs[["sailerx_colours"]], col.names = F)
```
